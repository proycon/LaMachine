...
if [ $DEV -eq 0 ]; then
    ...
    PACKAGES="ticcutils libfolia foliautils-git uctodata ucto timbl timblserver mbt mbtserver wopr-git frogdata frog ticcltools-git toad-git" #not everything is available as releases yet
else
