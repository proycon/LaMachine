...
LaMachine exists since May 2015 and has been used extensively ever since by numerous users. It was initiallly conceived
as the primary means of distribution of the software stack developed at CLST, Radboud University Nijmegen, it includes a
lot of our software.  A full list of included software goes beyond the scope of this overview; we will merely mention
...
as scipy, numpy, scikit-learn, matplotlib, nltk, spacy, pytorch, keras, gensim, and many others, but also R, Java and
tools such as Stanford CoreNLP.
