...
and provenance logging. Leveraging this metadata, LaMachine comes with a webserver that offers a portal website with
access and overview of all locally installed tools, including web services and web applications.
...
We participated in the dutch ZonMw project titled \emph{``Tekstmining in het toezicht: een exploratieve studie naar de
...
VM with Windows 2012, provided to us by the health inspectorate for this project, in which we did have administrative
...
content of the complaints, Timbl and the scikit-learn Python package \cite{scikit-learn} for classification, T-scan for
feature extraction and colibri-core for n-gram analysis.
