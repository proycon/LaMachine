...
LaMachine we also aims to harmonise the metadata of all installed software, by converting metadata from upstream repositories to
...
%Dit was er nog niet in de use-case formeel gezien
