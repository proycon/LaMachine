...
\cite{zinn2016}, which offers access to NLP tools through a web interface where users can upload their texts for
...
There are also other CLARIN initiatives that provide not just a switchboard, but aim at an even more ambitious high-level virtual research
