...
The CLARIN Switchboard \cite{zinn2016clarin} also offers access to NLP tools at a different level as it provides a webinterface where users can upload their texts for NLP processing, proving very easy acces. Lamachine is most often used by data scientists and reseachers who do have programming experience and want to work with complex NLP software.
...
Virtual Research Environments (VRE) such as the Dutch CLARIAH WP3 VRE project\footnote{\url{https://github.com/meertensinstituut/clariah-wp3-vre}} and the Spanish VRE project \cite{gonzalez2017evi} aim to develop more high level tool environments with graphical interfaces to accomodate the reseacher. Lamachine is currently developed in close collaboration with the Dutch CLARIAH WP3 VRE project.
...
connection, and using LaMachine to provide a work environment for a group of researchers. These case studies illustrate the advantages and limitations of Lamachine in practice.
