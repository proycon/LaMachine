...
Royal Library who %@Iris: zin niet afgemaakt?
...
However, for some situations LaMachine was not a good fit for the tasks at hand: For team members who did not have
experience with a non-Windows environment, LaMachine was not a suitable or useful tool. And also for members who wanted
to use a graphical user interface for their text editors as we did not manage to get the x-forwarding working (note that
this also depends on the overall VM). After a few attempts the team gave up on resolving this issue due to time pressure
but it also demonstrated that fine-tuning the configuration of LaMachine on certain aspects is beyond the reach of a data scientist without system administration skills.
