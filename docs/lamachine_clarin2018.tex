...
we had twelve participants and decided to create a single multi-core and hih memory VM to share amongst the
participants.

As recommended by SURFsara, we opted for one of their default Linux images based on Ubuntu 18.04, and we bootstrapped
the local installation flavor of LaMachine inside that VM.
