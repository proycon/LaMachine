...
\begin{enumerate}
    ...
    \item \textbf{Singularity container} - Another form of containerisation with more focus on security\footnote{reduced
        privilege escalation}, making it more suitable than Docker for deployment on computing clusters. This flavour is
...
software supports it. Certain Linux Distributions that are derivatives of these \emph{may} also work, such as RedHat
