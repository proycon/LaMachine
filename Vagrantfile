...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision :shell, path: "bootstrap.sh branch=develop", keep_color: true;
  ...
  #config.vm.provision :shell, path: "bootstrap.sh", args: "version=/tmp/VERSION", keep_color: true;
end
